<?php $__env->startSection('content'); ?>
    <div class="section big-85-height over-hide" style="background: url(<?php echo e(asset('img/home-main.gif')); ?>) no-repeat; background-attachment: fixed; background-size: cover;">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 img-slice-wrap mt-5 pb-5 over-hide">
                    <a class="parallax-elements js-tilt" href="<?php echo e(url('project/nda')); ?>" data-tilt-perspective="800" data-tilt-speed="700" data-tilt-max="10">
                ...
                <div class="offset-md-3 col-md-6 img-slice-wrap pt-5 pb-5 over-hide">
                    <a class="parallax-elements js-tilt" href="<?php echo e(url('project/uxpakistan')); ?>" data-tilt-perspective="800" data-tilt-speed="700" data-tilt-max="10">
                ...
                <div class="offset-md-6 col-md-6 img-slice-wrap pt-5 pb-5 over-hide">
                    <a class="parallax-elements js-tilt" href="<?php echo e(url('project/index')); ?>" data-tilt-perspective="800" data-tilt-speed="700" data-tilt-max="10">
                ...
                <div class="offset-md-3 col-md-6 img-slice-wrap pt-5 pb-5 over-hide">
                    <a class="parallax-elements js-tilt" href="<?php echo e(url('project/manzil')); ?>" data-tilt-perspective="800" data-tilt-speed="700" data-tilt-max="10">
                ...
                <div class="col-md-6 img-slice-wrap pt-5 pb-5 over-hide">
                    <a class="parallax-elements js-tilt" href="<?php echo e(url('project/chatbot')); ?>" data-tilt-perspective="800" data-tilt-speed="700" data-tilt-max="10">
                ...
                <div class="section clearfix"></div>
                <div class="offset-md-3 col-md-6 img-slice-wrap pt-5 pb-5 over-hide">
                    <a class="parallax-elements js-tilt" href="<?php echo e(url('project/onthedot')); ?>" data-tilt-perspective="800" data-tilt-speed="700" data-tilt-max="10">
                ...
                <div class="section clearfix"></div>
                <div class="offset-md-6 col-md-6 img-slice-wrap pt-5 pb-5 over-hide">
                    <a class="parallax-elements js-tilt" href="<?php echo e(url('project/xylawater')); ?>" data-tilt-perspective="800" data-tilt-speed="700" data-tilt-max="10">
